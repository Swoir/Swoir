...
[![Noir](https://img.shields.io/badge/Noir-1.0.0--beta.3--1-darkviolet)](https://github.com/Swoir/Swoirenberg)
...
let package = Package(
    ...
    // ...
    dependencies: [
        .package(url: "https://github.com/Swoir/Swoir.git", exact: "1.0.0-beta.3-1")
    ],
    // ...
    targets: [
